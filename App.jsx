      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="card flex items-center gap-3">
          ...
          <div className="flex-1">
            ...
            {adminEnabled ? <div className="text-sm">Aktywny — możesz edytować i usuwać wpisy oraz plan soboty.</div> : <div className="text-sm">Podaj hasło admina, aby aktywować.</div>}
          </div>
          {!adminEnabled && (
